...
############################Change File Path Here JI###############################################################################################
# Set paths depending on OS
if current_os == "Windows":
    parser.add_argument('--input-dir', default=r'd:\detailed_thermodynamcis\ThermodynamicsForJi\molefractions\dataset1')
    parser.add_argument('--csv-out-dir', default=r'd:\detailed_thermodynamcis\ThermodynamicsForJi\Ka_outputs\dataset1')
    parser.add_argument('--svg-out-dir', default=r'd:\detailed_thermodynamcis\ThermodynamicsForJi\Ka_outputs\dataset1')
else:
