...
#Any Questions ask KAE

def main():
    ##########################################Here is your Input from your data Ji#########################################################################################################
    # === Define the dynamic parts ===
    base_dir = "d:\detailed_thermodynamcis\ThermodynamicsForJi\Raw Data\H2O_AA_extrapt"

    ###########################################Here is where the file name is defined################################################################################################
    # Define the concentrations and subfolders (vT_1, vT_2, vT_3)
    concentrations = ["2uM", "5uM", "10uM", "15uM", "20uM", "25uM", "35uM", "65uM"]
    subfolders_vt = ["_vT_1", "_vT_2", "_vT_3", "_vT_4", "_vT_5", "_vT_6"]

    # Generate subfolder2 options dynamically from 5c to 50c with step size of 5
    subfolder2_options = [f"{i}c" for i in range(4, 42, 2)]  # Generates 5c, 10c, ..., 50c
    ...
    ##########################################Change Output Path Here JI#######################################################################################################
        ...
        output_file_path = f"d:\detailed_thermodynamcis\ThermodynamicsForJi\molefract_test/AA_MOL_{current_date}.csv"
